...
-- INSERT USER DE DÉMO
INSERT INTO user (pseudo, avatar, location, bio, email, password)
VALUES
('Jdoe', '###', '2, rue fantôme, 99 999 Lost', 'Je suis un fantôme', 'johndoe@gmail.com', 'dummy1'),
('PetitLoup', '###', '12, run de la neige, 59 999 Toundra', 'Je suis un petit loup mignon', 'petitloup@gmail.com', 'dummy2'),
('Jinloup', '###', '25, rue de la montagne, 59 999 Toundra', 'Le secret du loup', 'jinshi.wolf@gmail.com', 'dummy3'),
('Kitsune', '###', '58, rue de la renardière, 79 999 Fox', 'Le secret de la renarde', 'kitsunekiss@gmail.com', 'dummy4');
